...
/// Marker class used to locate the Beam framework bundle at runtime.
public final class GlowBeamBundle {}
...
public enum ShaderDispatch {
  static func shader(
    ...
    let function = ShaderFunction(
      library: .bundle(Bundle(for: GlowBeamBundle.self)),
  ...
  static func glyphFillShader(
    ...
    let function = ShaderFunction(library: .bundle(Bundle(for: GlowBeamBundle.self)), name: "beamGlyphFill")
    let args: [Shader.Argument] = [
  ...
  static func lensShader(
    ...
    let function = ShaderFunction(library: .bundle(Bundle(for: GlowBeamBundle.self)), name: "beamLens")
    let args: [Shader.Argument] = [
      .float4(
        Float(pixelSize.width),
        Float(pixelSize.height),
